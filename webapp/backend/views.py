...
def rootpage(request):
    return HttpResponse(f'''<header><h1>Calendrier de l'avent Noel 2024</h1><h3>Index des pages: <a href="combien/"><button>Combien d'élèves aujourd'hui</button></a>     <a href="eleve-au-hasard/"><button>Tirer un élève au hasard</button></a></h3></header><footer style=" vertical-align: bottom"><a href="admin"><button>/!\ADMIN/!\</button></a></footer>''')
